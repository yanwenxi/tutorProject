...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="background-image: url(../image/LeaveWordB.jpg); width: 98%">
        ...
        <tr>
            ...
            <td style="height: 67px; width: 219px;">
                <span style="font-size: 9pt">电话：</span></td>
            <td style="height: 67px; width: 203px;">
        ...
        <tr style="color: #000000; font-size: 9pt;">
            ...
            <td style="color: #000000; width: 219px;">
                <span>QQ：</span></td>
        ...
        <tr>
            <td style="height: 25px; width: 281px;">
            </td>
