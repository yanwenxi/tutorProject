...
//引入命名空间
public partial class AdminUser_AdminUser_Update : Page
{
    ...
    protected void BtnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            String SqlUpdate = "Update tb_UserLogin set UserName='" + TxtUserName.Text + "',role='" +
                               DdlRole.SelectedItem.Text + "',TrueName='" + TxtTrueName.Text + "',RetakePassword='" +
                               TxtRetakePwd.Text + "',AnswerPassWord='" + txtAnswerPassWord.Text + "',sex='" +
                               ddlSex.SelectedItem.Text + "' ,Age='" + TxtAge.Text + "',phone='" + TxtTel.Text +
                               "',Email='" + TxtEmail.Text + "',QQ='" + TxtQQ.Text + "', Address='" + TxtIntro.Text +
                               "' ,homepage='" + Txthomepage.Text + "',Intro='" + TxtIntro.Text + "',Image='" +
