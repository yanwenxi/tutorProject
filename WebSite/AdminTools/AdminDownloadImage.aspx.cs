...
public partial class AdminTools_AdminDownloadImage : Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (type == "bmp" || type == "BMP" || type == "jpg" || type == "JPG" || type == "gif" || type == "GIF")
        {
            ...
            try
            {
                LblImage.Text = "~/ToolsImage/" + LblImage.Text;
                String SqlInsert = "Insert tb_toolsimage values ('" + LblImage.Text + "')";
